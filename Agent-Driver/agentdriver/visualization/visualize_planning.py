...
def draw_text(sample_token, nusc, samples, plan_trajs_dict, gt_trajs_dict, experiment_tag='default'):
    sdc_pred_color = np.array([255, 51, 51]) / 255.0
    sdc_gt_color = np.array([51, 255, 51]) / 255.0
    # det_obj_color = np.array([51, 153,255]) / 255.0
    # tool_obj_color = np.array([255, 153, 51]) / 255.0
    ...
    save_path = save_dir / Path(sample_token + '_all.jpg')
    cam_render.save_fig(save_path)
...
if __name__ == "__main__":
    ...
    sample_json_path = '/path/to/Qwen3-VL/qwen-vl-finetune/results/nuscenes_rnbencorekgen_16_maxlen6144_30ep_lr6e-5_toks6144.jsonl'
    planning_pickle_path = '/path/to/Agent-Driver/results/nuscenes_rnbencorekgen_16_maxlen6144_30ep_lr6e-5.pkl'
    experiment_tag = 'nuscenes_rnbencorekgen_16_maxlen6144_30ep_lr6e-5'
    ...
    for sample_token in tokens:
        draw_text(sample_token, nusc, samples, plan_trajs_dict, gt_trajs_dict, experiment_tag=experiment_tag)
        # try:
